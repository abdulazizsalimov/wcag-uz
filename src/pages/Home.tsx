...
export default function Home() {
  ...
  return (
    <div>
      {/* Hero */}
      <section className="relative bg-gradient-to-br from-blue-700 via-blue-800 to-indigo-900 dark:from-blue-900 dark:via-gray-900 dark:to-gray-900 text-white overflow-hidden selection-on-dark">
